...
# DAG definition
dag = DAG(
    'ms_member_short_term_ver_refactor',
...
dataflow_job = BeamRunPythonPipelineOperator(
    ...
    py_file='gs://t1-dataflow-framework-bucket/jobs/ms_member_pipeline_v2.py',
    ...
    pipeline_options={
        ...
        'sdk_container_image': 'asia-southeast1-docker.pkg.dev/the1-insight-dev/dataflow-images/dataflow-worker:v2.0',  # custom container
